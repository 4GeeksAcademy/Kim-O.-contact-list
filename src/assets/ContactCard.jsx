    ...
    <div className="contact-card col-xl-4 col-sm-6 mb-3">
        <div className="bg-white rounded py-4 px-4 contact-card-border">
                ...
                <div className="image-circle">
                    <div className="profile-icon-container">
                        <img src="https://cdn1.iconfinder.com/data/icons/user-pictures/100/unknown-512.png"
                             alt="profile-icon" width="100" className="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm"/>
                    </div>
                </div>
            ...
            <div className="row mt-3">
                ...
                <div className="col-md-6">
                    <button className="btn btn-danger icon-button" onClick={() => console.log(contact.id)}>
